...
**NVIDIA**  
---
**NVIDIA GPU Operator** [оф дока](https://docs.nvidia.com/datacenter/cloud-native/gpu-operator/latest/index.html
...
---
**NVIDIA MIG Profiles (Multi-Instance GPU)** [оф дока](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/getting-started-with-mig.html) - позволяет нарезать мощные и дорогие видеокарты на нужные кусочки и раздавать их инференс моделям разного размера, тем самым плотно утилизируя дорогое железо.
